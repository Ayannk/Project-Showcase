    ...
    const displayProjects = () => {
        if (projectList.length === 0)
            ...
            return projectList.map(project => (
                <Link className="group relative block rounded-xl" href={"/project-details/" + project._id}>
                    <div className="flex-shrink-0 relative rounded-xl overflow-hidden w-full h-[250px] before:absolute before:inset-x-0 before:z-[1] before:size-full before:bg-gradient-to-t before:from-gray-900/70">
                        <img
