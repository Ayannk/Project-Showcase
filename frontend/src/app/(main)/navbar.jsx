  ...
  >
    ...
    >
      <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
        <Link
          className="font-medium text-black sm:py-6 dark:text-blue-500 hover:text-blue-500"
          href="/"
          aria-current="page"
        >
        Home
        ...
        <Link
          className="font-medium  text-black hover:text-blue-400 sm:py-6 dark:text-neutral-400 dark:hover:text-neutral-500"
          href="/about"
        >
          About
        </Link>
